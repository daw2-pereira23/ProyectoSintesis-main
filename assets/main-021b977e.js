...
const Swal$1 = sweetalert2Exports;
const sweetalert2 = "";
...
<div class="container-fluid text-center justify-content-center text-light">
  ...
  script: () => {
    ...
    fetch("https://api-2night.up.railway.app/api/discotecas", {
      method: "GET",
...
const editarPerfil = {
  ...
  script: (datosIntroducidos, id, name) => {
    ...
    document.querySelector("#guardarCambiosEditar").addEventListener("click", async () => {
      ...
      await fetch(`https://api-2night.up.railway.app/api/usuarios/update/${id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        ...
        if (void 0 == data)
          ...
          Swal.fire(
            ...
            document.querySelector("main").innerHTML = interfaz$1.template;
            interfaz$1.script();
          });
        }
      }).catch(console.log);
...
const admin = {
  ...
  script: async () => {
    ...
    fetch("https://api-2night.up.railway.app/api/usuarios", {
      method: "GET",
      headers: { "Content-Type": "application/json" }
    }).then((resp) => resp.json()).then((data) => {
      ...
      document.addEventListener("click", (event) => {
        if (event.target.classList.contains("editar")) {
          ...
          console.log(`Clic en el elemento con data-id: ${id2}`);
          const fila = event.target.closest("tr");
          const nombre = fila.querySelector(".nombre").textContent;
          const email2 = fila.querySelector(".email").textContent;
          const rol2 = fila.querySelector(".rol").textContent;
          document.querySelector("#nombre4").value = nombre;
          document.querySelector("#email4").value = email2;
          document.querySelector("#rol4").value = rol2;
          document.querySelector("#eliminarUsuario").addEventListener("click", () => {
            Swal$1.fire({
              ...
              if (result.isConfirmed) {
                fetch(`https://api-2night.up.railway.app/api/usuarios/delete/${id2}`, {
                  method: "DELETE",
          ...
          document.querySelector("#guardarCambiosEditarAdmin").addEventListener("click", () => {
            ...
            if (estadoForm == true) {
              ...
              fetch(`https://api-2night.up.railway.app/api/usuarios/update/${id2}`, {
                method: "PUT",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify(updateUsuario)
            ...
            if (estadoForm == false) {
              Swal$1.fire("Revisa Bien Los Campos");
            }
          });
        }
      });
    ...
    document.addEventListener("click", (event) => {
      if (event.target.classList.contains("noticias")) {
        ...
        const descripcion2 = document.createElement("th");
        descripcion2.innerHTML = "Descripcion";
        encabezado.append(descripcion2);
        ...
        fetch("https://api-2night.up.railway.app/api/noticias", {
          method: "GET",
          headers: { "Content-Type": "application/json" }
        }).then((resp) => resp.json()).then((data) => {
          console.log(data);
          ...
          for (let i = 0; i < dataNoticias.length; i++) {
            ...
            num.innerHTML = i;
            row.append(num);
            const nombre2 = document.createElement("td");
            nombre2.classList.add("nombreNoticia");
            nombre2.innerHTML = data.noticias[i].title;
            row.append(nombre2);
            const descripcion3 = document.createElement("td");
            descripcion3.classList.add("descripcion");
            descripcion3.innerHTML = data.noticias[i].description;
            row.append(descripcion3);
            const tags2 = document.createElement("td");
            tags2.classList.add("tags");
            tags2.innerHTML = data.noticias[i].tags;
            row.append(tags2);
        ...
        document.addEventListener("click", (event2) => {
          if (event2.target.classList.contains("edicionNoticia")) {
            const id = event2.target.dataset.id;
            console.log(id);
            const fila = event2.target.closest("tr");
            const nombre2 = fila.querySelector(".nombreNoticia").textContent;
            const descripcion3 = fila.querySelector(".descripcion").textContent;
            const tags2 = fila.querySelector(".tags").textContent;
            document.querySelector("#tituloNoticia").value = nombre2;
            document.querySelector("#descripcionNoticia").value = descripcion3;
            document.querySelector("#tagsNoticia").value = tags2;
            document.querySelector("#guardarCambiosNoticia").addEventListener("click", () => {
              ...
              if (estadoForm == true) {
                ...
                fetch(`https://api-2night.up.railway.app/api/noticias/update/${id}`, {
                  method: "PUT",
                  headers: { "Content-Type": "application/json", "token": token },
                  ...
                  if (void 0 == data) {
                    ...
                    Swal$1.fire(
                      ...
                      while (encabezado2.firstChild) {
                        encabezado2.removeChild(encabezado2.firstChild);
                      }
              ...
              if (estadoForm == false) {
                sweetalert2Exports.swal.fire("Revisa Bien Los Campos");
              }
            });
            document.querySelector("#eliminarNoticias").addEventListener("click", () => {
              ...
              Swal$1.fire({
                ...
                if (result.isConfirmed) {
                  fetch(`https://api-2night.up.railway.app/api/noticias/delete/${id}`, {
                    method: "DELETE",
                    headers: { "Content-Type": "application/json", "token": token }
                  });
                  Swal$1.fire(
      ...
      if (event.target.classList.contains("discotecas")) {
        ...
        fetch("https://api-2night.up.railway.app/api/discotecas", {
          ...
          for (let i = 0; i < dataArray[0].length; i++) {
            ...
            const descripcion3 = document.createElement("td");
            descripcion3.classList.add("descripcion");
            descripcion3.innerHTML = data.discotecas[i].description;
            row.append(descripcion3);
            const email2 = document.createElement("td");
            email2.classList.add("emailDiscoteca");
            email2.innerHTML = data.discotecas[i].email;
            row.append(email2);
            const tags2 = document.createElement("td");
            tags2.classList.add("tags");
            tags2.innerHTML = data.discotecas[i].tags;
            row.append(tags2);
          ...
          document.addEventListener("click", (event2) => {
            if (event2.target.classList.contains("edicionDiscoteca")) {
              const id = event2.target.dataset.id;
              const fila = event2.target.closest("tr");
              const nombreDiscoteca2 = fila.querySelector(".nombreDiscoteca").textContent;
              const descripcion3 = fila.querySelector(".descripcion").textContent;
              const email2 = fila.querySelector(".emailDiscoteca").textContent;
              const tags2 = fila.querySelector(".tags").textContent;
              document.querySelector("#nombreDiscoteca").value = nombreDiscoteca2;
              document.querySelector("#descripcion").value = descripcion3;
              document.querySelector("#emailDiscoteca").value = email2;
              document.querySelector("#tags").value = tags2;
              document.querySelector("#eliminarDiscoteca").addEventListener("click", () => {
                Swal$1.fire({
                  ...
                  if (result.isConfirmed) {
                    fetch(`https://api-2night.up.railway.app/api/discotecas/delete/${id}`, {
                      method: "DELETE",
                      headers: { "Content-Type": "application/json", "token": token }
                    });
                    Swal$1.fire(
                    ...
                    const tbody3 = document.querySelector("tbody");
                    const encabezado2 = document.querySelector("#encabezado");
                    while (encabezado2.firstChild) {
                      encabezado2.removeChild(encabezado2.firstChild);
                    }
              ...
              document.querySelector("#guardarCambiosDiscoteca").addEventListener("click", () => {
                ...
                if (estadoForm == true) {
                  console.log(estadoForm);
                  const id2 = event2.target.dataset.id;
                  console.log("Discoteca a editar" + id2);
                  ...
                  fetch(`https://api-2night.up.railway.app/api/discotecas/update/${id2}`, {
                    method: "PUT",
                    headers: { "Content-Type": "application/json", "token": token },
                ...
                if (estadoForm == false) {
                  Swal$1.fire("Revisa Bien Los Datos");
                }
              });
            }
          });
...
const crearAdmin = {
  ...
  script: () => {
    ...
    document.addEventListener("click", (event) => {
      if (event.target.classList.contains("noticias")) {
        ...
        document.querySelector("#crearNoticia").addEventListener("click", async () => {
          ...
          var urlEndpoint = "https://api-2night.up.railway.app/api/noticias/create";
          fetch(urlEndpoint, {
            method: "POST",
            headers: { "Content-Type": "application/json", "token": token },
    ...
    document.querySelector("#crearUser").addEventListener("click", async () => {
      ...
      var urlEndpoint = "https://api-2night.up.railway.app/api/usuarios/create";
      fetch(urlEndpoint, {
        method: "POST",
        headers: { "Content-Type": "application/json", "token": token },
    ...
    document.addEventListener("click", (event) => {
      if (event.target.classList.contains("discotecas")) {
        ...
        document.querySelector("#crearDiscoteca").addEventListener("click", async () => {
          ...
          const emailDiscoteca2 = document.querySelector("#emailDiscoteca").value;
          ...
          var urlEndpoint = "https://api-2night.up.railway.app/api/discotecas/create";
          fetch(urlEndpoint, {
            method: "POST",
            headers: { "Content-Type": "application/json", "token": token },
            body: JSON.stringify(datos)
...
const descubrir = {
  ...
  script: async () => {
    ...
    fetch("https://api-2night.up.railway.app/api/discotecas", {
      ...
      const dataArray = Object.values(data);
      for (let i = 0; i < dataArray[0].length; i++) {
        const popup = new L.popup().setLatLng([data.discotecas[i].latitude, data.discotecas[i].longitude]).setContent(`
        ...
        `);
        new L.Marker([data.discotecas[i].latitude, data.discotecas[i].longitude]).bindPopup(popup).openPopup().addTo(map);
      }
    }).catch((error) => {
      console.error(error);
    });
  ...
  script: () => {
    fetch("https://api-2night.up.railway.app/api/noticias", {
      ...
      for (let index = 0; index < dataNoticias.length; index++) {
        ...
        descripcion2.innerHTML = data.noticias[index].description;
        inyeccion.append(descripcion2);
        const tags = document.createElement("p");
...
const login = {
  ...
  script: () => {
    document.querySelector("#buttonLogin").addEventListener("click", async (e) => {
      ...
      await fetch("https://api-2night.up.railway.app/api/auth/login", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
